...
class SensorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GenerateSensorData = channel.unary_unary(
                '/sensor.SensorService/GenerateSensorData',
...
def add_SensorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GenerateSensorData': grpc.unary_unary_rpc_method_handler(
                    servicer.GenerateSensorData,
...
class SensorService(object):
    ...
    @staticmethod
    def GenerateSensorData(request,
            target,
            options=(),
